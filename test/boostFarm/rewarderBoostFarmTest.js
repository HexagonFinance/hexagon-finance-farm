...
const RewarderSC = artifacts.require("boostMultiRewarderTime");
...
////////////////////////////////////////////////////////////////////////
    ...
    async function havestTest(staker) {
        ...
        let preRewarderTokenBal = await rewarderToken.balanceOf(staker);
        console.log("preRewarderTokenBal=",preRewarderTokenBal.toString(10));
        ...
        console.log("chef reward get:",diff);

        let afterRewarderTokenBal = await rewarderToken.balanceOf(staker);
        console.log("preRewarderTokenBal=",afterRewarderTokenBal.toString(10));
        let diff2 = web3.utils.fromWei(afterRewarderTokenBal) - web3.utils.fromWei(preRewarderTokenBal);

        console.log("rewarder get:",diff2);
...
/////////////////////////////reward token///////////////////////////////////////////
        ...
        rewarderToken = await FlakeToken.new("rewarderToken","rewarderToken",18);
...
/////////////////////////////set rewarder/////////////////////////////////////
        rewarder = await RewarderSC.new(farminst.address,0);
        await rewarder.add(rewarderToken.address,rewardPerSec);
        await rewarderToken.mint(rewarder.address,VAL_1B)

        await farminst.set(0,new BN(100),rewarder.address,true);
